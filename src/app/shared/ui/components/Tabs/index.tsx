    ...
    <div className={`relative box-border ${className}`} style={{ width: "100%" }}>
      <div className="relative w-full border-b border-zinc-100 dark:border-zinc-700">
        {showLeftScroll && (
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-0 bottom-0 z-10 flex items-center justify-center px-1
        ...
        {showRightScroll && (
          <button
            ...
            className="absolute right-0 top-0 bottom-0 z-10 flex items-center justify-center px-1
