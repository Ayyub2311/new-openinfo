...
import { MicroQuarterFinancialResultsResp } from "../nested/MicroQuarterfinancialresultresp";
import { Quarterreportresp } from "../nested/Quarterreportresp";

export class MicroQuarterlyReport extends ReportBase {
  @IsArray()
  ...
  @IsArray()
  quarter_report_resp: MicroQuarterFinancialResultsResp[];
  ...
  get getQuarterFinancialResultsSection(): FactBuilderSectionTable {
    return {
      ...
      props: {
        ...
        tableProps: {
          columns: MicroQuarterFinancialResultsResp.getColumns,
