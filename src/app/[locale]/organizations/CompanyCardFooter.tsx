...
const CompanyCardFooter: React.FC<CompanyCardFooterProps> = ({ inn, status }) => {
  ...
  const statusBadgeColor = {
    ...
    default: "bg-gray-100 text-gray-700 border border-default",
  };
    ...
    <div className="w-full bg-slate-50 px-4 py-3 rounded-xl border-t border-default">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-sm text-gray-700 text-center sm:text-left">
        ...
        <div className="flex flex-wrap justify-center sm:justify-start items-center gap-2">
          ...
          <span className="inline-block rounded-full px-2.5 py-1 text-xs font-medium bg-gray-100 text-gray-800 border bborder-default">
            {inn ?? "-"}
          </span>
        </div>
